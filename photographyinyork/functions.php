...
function piy_enqueue() {
	piy_register_style('angular', PIY_LIB_DIR . '/angular/angular-csp.css', '6.3.1');
	...
	piy_register_lib('angular', '/angular/angular', '1.6.3', array('jquery'));
	piy_register_script('piy', '/index', array('jquery', 'foundation'));

	piy_enqueuer('style', array('angular', 'foundation', 'main'));
	piy_enqueuer('script', array('jquery', 'what-input', 'foundation', 'angular', 'piy'));
}
