<?php
class PIY_Walker_Nav_Menu_Edit extends Walker_Nav_Menu  {
	/**
	...
	<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
		...
		<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
			...
			<p class="field-hide_title description">
				<label for="edit-menu-item-hide-title-<?php echo $item_id; ?>">
					<input type="checkbox" id="edit-menu-item-hide-title-<?php echo $item_id; ?>" value="yes" name="menu-item-hide-title[<?php echo $item_id; ?>]"<?php checked( $item->hide_title, 'yes' ); ?> />
					<?php _e( 'Hide title?' ); ?>
				</label>
			</p>
