<footer class="row medium-12 columns">
	<div class="footer-main row">
		<div class="medium-4 columns footer-main-block1">
			<a href="<?php echo get_home_url(); ?>" class="logo-wrap"><img src="<?php echo PIY_DIR.'/images/logo.png'; ?>" class="logo" /></a>
		</div>
		<div class="medium-4 columns footer-main-block2"><i class="fa fa-phone" aria-hidden="true"></i> Make a booking 01234 56789</div>
